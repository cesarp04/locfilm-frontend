            ...
            <section className="container__imgDate">
                ...
                <div  className="container__imgData__data">
                    ...
                    <div className="container__imgData__data--CheckIn">
                        <p>Check in:</p>
                        <DatePicker className="Container__datesAndSlider__dates--choose--datePickerCheckout" selected={startDate} onChange={date => testStart(date)}
                            selectsStart
                            startDate={startDate}
                            endDate={endDate} 
                        />
                    ...
                    <div className="container__imgData__data--CheckOut">
                        <p>Check out:</p>
                        <DatePicker className="Container__datesAndSlider__dates--choose--datePickerCheckout" selected={endDate} onChange={date => testEnd(date)}
                            selectsEnd
                            startDate={startDate}
                            endDate={endDate}
                            minDate={startDate}
