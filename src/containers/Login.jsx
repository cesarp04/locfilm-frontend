    ...
    <main className="login">
        <section className="login__container">
            ...
            <form className="login__container__from">
                <input type="text" className="login__container__form--input" placeholder="Your email"/>
                <input type="password  " className="login__container__form--input" placeholder="Your Password"/>
            ...
            <section className="login__container__SM">
                <div>
                    <a href="#"><img src={googleIcon} alt="Google"/>Login with Google</a>
                </div>
                <div>
                    <a href="#"><img src={twitterIcon} alt="Twitter"/>Login with Twitter</a>
                </div>
            </section>
            <div className="login__container__register">
                <p>You dont have any account. <a href="#">Register</a></p>
            </div>
        </section>
    </main>
);
